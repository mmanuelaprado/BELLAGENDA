          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center bg-gray-100 border border-gray-100 rounded-2xl overflow-hidden focus-within:ring-2 focus-within:ring-[#FF1493]">
                <span className="px-5 py-4 text-gray-400 font-black text-[10px] uppercase tracking-widest border-r border-gray-200">
                  {window.location.origin.replace('https://', '').replace('http://', '')}/?b=
                </span>
                <input 
                  type="text" 
